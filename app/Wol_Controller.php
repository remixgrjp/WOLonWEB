...
require_once 'Wol_Error.php';
require_once 'Wol_ActionClass.php';
require_once 'Wol_ActionForm.php';
require_once 'Wol_ViewClass.php';

/**
*  Wol application Controller definition.
*
*  @author  remix
*  @access  public
*  @package Wol
*/
class Wol_Controller extends Ethna_Controller
{
	/**#@+
	* @access private
	*/
